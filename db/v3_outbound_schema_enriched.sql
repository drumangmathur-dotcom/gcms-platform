-- GCMS v3.0 Outbound Stack Schema - ENRICHED CONTENT UPDATE
-- Run this to update existing programs with researched content and additional images

-- Update University of Wisconsin with researched content
UPDATE programs
SET content_json = '{
    "images": [
        "/brain/80c4bfdd-a0d6-41c2-b703-d5cc9b2646db/wisconsin_hospital_exterior_1770492945200.png",
        "/brain/80c4bfdd-a0d6-41c2-b703-d5cc9b2646d b/wisconsin_clinical_training_1770492966337.png",
    ...
    "disadvantages": [
        ...
        "Smaller Social Scene: More subdued nightlife and international community compared to Chicago or costal hubs",
    ...
    "departments": ["Internal Medicine", "Surgery", "Ophthalm ology", "Pediatrics", "Family Medicine", "Emergency Medicine"],
    "duration": "4 weeks",
...
WHERE slug = 'wisconsin';

-- Update Johns Hopkins University with researched content
UPDATE programs
SET content_json = '{
    "images": [
...
-- Update University of Edinburgh with researched content
UPDATE programs
SET content_json = '{
    "images": [
    ...
    "advantages": [
        "NHS System Mastery: Learn socialized medicine firsthand - valuable for global health understanding and UK career pathways",        "GMC Registration Pathway Support: Clinical attachment experience strengthens General Medical Council (GMC) registration applications for UK practice",
        ...
        "Affordable Compared to US: Matriculation fees (£400) and living costs are significantly lower than comparable US programs"
    ],
    "disadvantages": [
